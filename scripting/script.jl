...
# trial_cases = Dict("ephrinBKO" => "ephrinBKO", "ephrinTKO" => "ephrinTKO")
...
# #------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    koulakov_data = [4000, 2370],[3000, 973], [1000, 25], [2000, 275] # [[100, 1.9], [500, 4.1], [1000, 25], [2000, 275], [3000, 973], [4000, 2370]]#, [5000, 4755]]
    ...
    plot!(runtime_plt, koulakov_x, predict(koulakov_fit), label="", color=:black)

    plot!(runtime_plt, d_x, d_t, seriestype=:line, markershape=:rect, color=RGB(0.6350, 0.0780, 0.1840), label="Distributed Kernels")
    plot!(runtime_plt, d_x, predict(d_fit), label="", color=:black)
